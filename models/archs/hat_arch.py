# Adapted from:  HAT (https://github.com/XPixelGroup/HAT)
# Apache License 2.0
#
# This file has been modified for use in the PAWS project.
#
# Original copyright:
# Copyright (c) 2023 Xiangyu Chen. Licensed under the Apache License, Version 2.0.
...
class CleaningModuleHAT(nn.Module):
    def __init__(self,
                 img_size=64,
                 patch_size=1,
                 in_chans=3,
